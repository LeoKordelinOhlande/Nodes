...
namespace Nodes
{
    internal class ExampleNode : Node
    {
        ...
        {
            inputs[0] = new DataInput<object?, Node>(nodeManager, "Input A", this, typeof(int), font);
            inputs[1] = new DataInput<object?, Node>(nodeManager, "Input B", this, typeof(float), font);
            outputs[0] = new DataOutput<object?, Node>(nodeManager, "Output", this, typeof(string), font);
        }
